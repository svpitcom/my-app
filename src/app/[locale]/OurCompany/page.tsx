...
export default function OurCompany() {
  return (
    ...
    <div>
      <div className="bg-[url('/assets/imgs/DJI_0673.jpg')] bg-cover bg-center text-white w-full relative py-60">
        
      </div>
      <div className="bg-gradient-to-br from-sky-600 to-green-500 bg-cover bg-center py-10">

    <div className="bg-gradient-to-br from-sky-600 to-green-500 bg-cover bg-center">
      <div className="bg-gradient-to-b bg-white/20 via-white to-white bg-cover bg-center text-white h-full py-2">
        <div className="bg-[url('/assets/imgs/DJI_0668.jpg')] bg-cover bg-center text-white w-full relative py-60">
