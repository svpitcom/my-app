          ...
          <div className="bg-neutral-50 text-black py-10 md:py-16 px-4 md:px-10 text-center">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-base md:text-lg text-left leading-relaxed">
                ...
                produced meets the required standard of our customers. SV
                Polymer core operations are processing of Standard Thai Rubber
                grade STR10, and STR20 as well as Mooney viscosity controlled
                9710 and 9720.
              </p>
              <br />
              <p className="text-base md:text-lg text-left leading-relaxed">
                ...
                Currently, our annual production capacity is 72,000 tons that
                will be continuously expanded to support the growth of both
