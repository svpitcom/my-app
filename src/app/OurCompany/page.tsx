...
export default function OurCompany() {
  return (
    <div className="bg-cover bg-center min-h-screen text-center">
      <div className="flex flex-col bg-[url('/assets/imgs/backgruondconstus.jpg')] w-full h-full">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <h1 className="text-white text-6xl font-bold mb-4 bg-black/50 p-4 rounded">
            About Us
          </h1>
          <div className="bg-white w-full text-gray-800 p-10 rounded-lg shadow-lg text-balance">
