    ...
    <div className="bg-white bg-cover bg-center w-full">
      <div className="bg-[url('/assets/imgs/backgruondconstus.jpg')] bg-cover bg-center w-full h-full">
        <div className="flex justify-center py-40">
          <h1 className="text-white text-6xl font-bold mb-4 bg-black/50 py-10 rounded">
            OurProduct
          </h1>
        </div>
        <section className="bg-neutral-50 text-black py-20 px-6 text-center">
          ...
          <p className="text-lg md:text-xl mb-6">
            ...
            meets the required standard of our customers. Nteq core operations
            are processing of Standard Thai Rubber grade STR10, and STR20 as
            well as Mooney viscosity controlled 9710 and 9720.Customization of
            products or special request specifications of quality are always
            welcome. Our further research and development will lead to future
            production of new value added products. Currently, our annual
            production capacity is 72,000 tons that will be continuously
            expanded to support the growth of both domestic and international
            demands.
          </p>
        </section>
        <div className="flex items-center bg-blue-700">
          <Image
            ...
            height={500}
          />
          <div className="md:w-1/2 text-white flex flex-col justify-center min-h-screen">
        ...
        <div className="bg-white py-12 px-2 text-center">
          ...
          <p className="text-sm max-w-2xl mx-auto mb-10">
            ...
            close supervision to ensure that rubber arrives at the destination
