...
export default function SustainableNatural() {
  return (
    <div className="flex flex-col justify-center text-center text-xl bg-white text-black item-center">
      ...
      <div className="text-left grid grid-cols-6 gap-4">
        ...
        <p className="col-start-2 col-end-6 p-2">
          ...
          the ever-changing challenges and Contributing to the well-being of the
          humanity, we base our values in
        </p>
        {/* //ทำเป็นข้อ */}
        <ul className="list-disc col-start-2 col-end-6 p-2">
        ...
        <p className="list-disc col-start-2 col-end-6 p-2"></p>
        <p className="col-start-2 col-end-6 p-2">
        ...
        <ul className="col-start-2 col-end-6 p-2">
          ...
          <li>
            2.1.1. Producing and sourcing natural rubber in a way that does not
            contribute to deforestation or degrade High Conservation Values
            ...
            HCV Approach and with the High Carbon Stock Approach (HCSA).
          </li>
          <li>
            2.1.2. Natural rubber from areas deforested or where HCVs have been
            degraded after the cutoff date of 1 April 2019 is considered to be
            non-conforming with this policy element.
          </li>
          <li>
            ...
            supporting restoration of deforested and degraded rubber landscapes.
            SV Polymer Sustainable Natural Rubber Policy
          </li>
          <li>
          ...
          <li>
            2.4. Protecting wildlife, including rare, threatened, endangered and
            critically endangered species from poaching, over-hunting and
            ...
            except certain instances of sustainable hunting by local communities
            for subsistence purposes that do not cause decline of local species
            populations.
          </li>
          <li>
        ...
        <ul className="col-start-2 col-end-6 p-2">
          ...
          <li>
            ...
            (consistent with UNGP effectiveness criteria) to receive complaints
            and remedy adverse impacts they have caused due to production and
            sourcing.
          </li>
          <li>
            3.3. Recognizing and protecting the customary, traditional and
            communal land tenure rights of indigenous peoples and local
            communities (IP/LC) including: Carrying out operations in accordance
            with the UN Declaration on the Rights of Indigenous Peoples (UNDRIP)
            Ensuring ongoing land tenure and access rights Upholding traditional
            rights of access for hunting and gathering of animals and plants for
            the purpose of subsistence and indigenous cultural and religious
            traditions, customs and ceremonies
          </li>
          <li>3.4. Free, prior, and informed consent (FPIC) </li>
          <li>
            3.4.1. Ensuring that, prior to any activity that might affect IP/LC
            rights to their lands, territories, and resources, their free,
            prior, and informed consent (FPIC) is secured. This includes when
            planning, establishing, restoring, or transforming corporate
            plantations and/or industrial sites. as well as associated
            infrastructure. The FPIC process is done in a culturally appropriate
            manner and follows credible accepted methodologies and associated
            GPSNR guidance. IP/LC have the right to give or withhold their
            consent to any activity that is subject to the FPIC process.
          </li>
          <li>
          ...
          <li>
            ...
            jurisdictions where operating, the UN Guiding Principles on Business
            and Human Rights, and the intent of the International Labor
            Organizations eight core conventions. This includes:{" "}
          </li>
          <li>
          ...
          <li>
            ...
            least equal to the countrys minimum salary for an equivalent job
            with the view of fostering an adequate/decent living wage as
            envisioned by the ILO Conventions 100, 105 and 131)
          </li>
          <li>
            3.6.5. No discrimination (ILO Convention No. 111 and No. 100),
            including eliminating gender related discrimination with regards to
            employment{" "}
          </li>
        ...
        <ul className="col-start-2 col-end-6 p-2">
          ...
          <li>
            4.1. Supporting decent living conditions of local communities (e.g.,
            drinking water, adequate housing. sanitation), including essential
            community services and facilities.
          </li>
          <li>
            4.2. Supporting the right to food and food security of individuals,
            households and local communities. Mitigating impacts on food
            security.
          </li>
          <li>
        ...
        <ul className="col-start-2 col-end-6 p-2">
          ...
          <li>
            ...
            commitments. SV Polymer Sustainable Natural Rubber Policy{" "}
          </li>
          <li>
            6.2. Embedding commitments into decision-making processes, systems,
            and performance metrics of corporate management, relevant business
            units, joint ventures, and company affiliates and subsidiaries.{" "}
          </li>
          <li>
            6.3. Maintaining an active, regular stakeholder dialogue to provide
            relevant information, and to afford opportunities for feedback and
            suggestions related to fulfillment of the company s commitments.
          </li>
          <li>
            ...
            those defined by industry platforms such as the Global Platform for
            Sustainable Natural Rubber) at a landscape, jurisdictional or other
            spatial level.
          </li>
        </ul>
        <ul className="col-start-2 col-end-6 p-2">
          ...
          <li>
            ...
            of purchased materials with these Policy Components.
          </li>
          <li>
            7.3. Communicating to all suppliers of natural rubber that material
            ...
            ensuring that supplier codes and contracts, engagement activities,
            and other mechanisms reflect these supplier expectations.
          </li>
          <li>
          ...
          <li>
            ...
            implementation plans to move towards conformance and/or remediation
            of past or ongoing harms.
          </li>
        </ul>
        <ul className="col-start-2 col-end-6 p-2">
          <li>
        ...
        <ul className="col-start-2 col-end-6 p-2">
          ...
          <li>
            9.1.1. SV Polymer is committed to conducting business in an ethical
            and honest manner and is committed to implementing and enforcing
            systems that ensure all forms of bribery, corruption, and fraud are
            prevented. SV Polymer has zero tolerance for bribery and corrupt
            activities. We are committed to acting professionally, fairly, and
            with integrity in all business dealings and relationships we build
            with our employees. SV Polymer will constantly uphold all laws
