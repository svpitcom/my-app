  ...
  return (
    <div className="bg-cover bg-center h-full w-full">
      <div className="bg-[url('/assets/imgs/svp-office-tree.jpg')] bg-cover bg-center bg-radial text-white h-full">
        <div className="flex flex-col text-center items-center bg-white/75">
          ...
          />
          {/* </div> */}
          {/* <div className="bg-radial bg-white/75"> */}
      ...
      <AnimateOnScroll>
        <div className="bg-sky-700 text-white py-10 text-center">
          <h1 className="text-6xl md:text-6xl font-bold mb-3 p-4">
            Energy Conservation Policy
          </h1>
          <p className="max-w-4xl mx-auto text-xl md:text-xl p-6">
      ...
      <div className="bg-[url('/assets/imgs/Towertree.png')] bg-cover bg-center p-2">
        ...
        <AnimateOnScroll>
          <div className="flex mx-auto py-4 justify-center items-center bg-white rounded-lg w-full">
            <div className="max-w-3xl text-center">
              ...
              <h4 className="text-gray-700 text-4xl font-semibold mb-2">
